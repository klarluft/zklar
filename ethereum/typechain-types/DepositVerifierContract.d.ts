...
interface DepositVerifierContractInterface extends ethers.utils.Interface {
  functions: {
    "verifyTx(((uint256,uint256),(uint256[2],uint256[2]),(uint256,uint256)),uint256[3])": FunctionFragment;
  };
...
export class DepositVerifierContract extends BaseContract {
  ...
  interface: DepositVerifierContractInterface;
