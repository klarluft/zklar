...
export function generateAccount(poseidon: PoseidonFunction, seed: [number, number]): Account {
  ...
  const account_digest = poseidon.F.toObject(poseidon([account_digest_preimage_0, account_digest_preimage_1]));
